    ...
    return (
      <div>
        <Router>
          <NavBar />
          <Routes>
            <Route exact path ="/" element={<News key="" pageSize={this.pageSize} country="us" category="general"/>}/>
            <Route exact path ="/about" element={<News key="general" pageSize={this.pageSize} country="us" category="general"/>}/>
